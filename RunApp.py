...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        vo=r'C:\Users\fahmi\Desktop\clustering model\ico.ico'
        self.iconbitmap(vo)
...
#########################################################################################################
    ...
    def cluster_data(self):
        ...
        for k in range(30):
            ...
            pathf=r"C:\Users\fahmi\Desktop\clustering model\save_as"+"\\"+p
        ...
        Message='File 1 saved as : '+'\n' + r"C:\Users\fahmi\Desktop\clustering model\save_as"
        self.label_info_1 = customtkinter.CTkLabel(master=self.frame_info,
                                                   text= Message,
                                                   height=100,
                                                   fg_color=("white", "gray38"),  # <- custom tuple-color
